...
class PubExamResultResModel {
  ...
  factory PubExamResultResModel.fromJson(String str) =>
      PubExamResultResModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PubExamResultResModel.fromMap(Map<String, dynamic> json) =>
      PubExamResultResModel(
        studentExamResult: json["student_exam_result"] == null
            ? []
            : List<StudentExamResult>.from(json["student_exam_result"]!
                .map((x) => StudentExamResult.fromMap(x))),
        mode: json["mode"],
        status: json["status"],
      );

  Map<String, dynamic> toMap() => {
        "student_exam_result": studentExamResult == null
            ? []
            : List<dynamic>.from(studentExamResult!.map((x) => x.toMap())),
        "mode": mode,
        "status": status,
      };
}
...
class StudentExamResult {
  ...
  factory StudentExamResult.fromJson(String str) =>
      StudentExamResult.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory StudentExamResult.fromMap(Map<String, dynamic> json) =>
      StudentExamResult(
        ...
        resultPublicFullPublishStatus:
            json["result_public_full_publish_status"],
        status: json["status"],
      );
...
class StudentHistory {
  ...
  factory StudentHistory.fromMap(Map<String, dynamic> json) => StudentHistory(
        ...
        student: json["student"] == null
            ? Student()
            : Student.fromMap(json["student"]),
        site: json["site"],
        year: json["year"] == null ? Year() : Year.fromMap(json["year"]),
        shift: json["shift"] == null ? Shift() : Shift.fromMap(json["shift"]),
        department: json["department"],
        stClass: json["st_class"] == null
            ? StClass()
            : StClass.fromMap(json["st_class"]),
...
class DependentSubjectListElement {
  ...
  factory DependentSubjectListElement.fromMap(Map<String, dynamic> json) =>
      DependentSubjectListElement(
        ...
        examinationNameKey:
            examinationNameKeyValues.map[json["examination_name_key"]],
  ...
  Map<String, dynamic> toMap() => {
        ...
        "examination_name_key":
            examinationNameKeyValues.reverse[examinationNameKey],
...
class ExamTypeList {
  ...
  factory ExamTypeList.fromMap(Map<String, dynamic> json) => ExamTypeList(
        ...
        academicExamTypeName:
            academicExamTypeNameValues.map[json["academic_exam_type_name"]],
        examinationId: json["examination_id"],
        id: json["id"],
  ...
  Map<String, dynamic> toMap() => {
        ...
        "academic_exam_type_name":
            academicExamTypeNameValues.reverse[academicExamTypeName],
        "examination_id": examinationId,
        "id": id,
...
enum AcademicExamTypeName { CQ, MCQ, PRACTICAL }
...
enum ExaminationName { TEST_EXAM }

final examinationNameValues =
    EnumValues({"Test Exam": ExaminationName.TEST_EXAM});

enum ExaminationNameKey { TERMEXAM }

final examinationNameKeyValues =
    EnumValues({"termexam": ExaminationNameKey.TERMEXAM});
...
class IndivisualStudentSubjectList {
  ...
  factory IndivisualStudentSubjectList.fromMap(Map<String, dynamic> json) =>
      IndivisualStudentSubjectList(
        ...
        examDependentAcademicSubject: json["exam_dependent_academic_subject"],
        subjectExamNameKey:
            subjectExamNameKeyValues.map[json["subject_exam_name_key"]]!,
  ...
  Map<String, dynamic> toMap() => {
        ...
        "exam_dependent_academic_subject": examDependentAcademicSubject,
        "subject_exam_name_key":
            subjectExamNameKeyValues.reverse[subjectExamNameKey],
...
enum SubjectExamName { FOR_CLASS_EXAM }

final subjectExamNameValues =
    EnumValues({"For Class & Exam": SubjectExamName.FOR_CLASS_EXAM});

enum SubjectExamNameKey { FORCLASSANDEXAM }

final subjectExamNameKeyValues =
    EnumValues({"forclassandexam": SubjectExamNameKey.FORCLASSANDEXAM});
