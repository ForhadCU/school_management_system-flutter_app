...
MonthWiseEventCalendarApiModel monthWiseEventCalendarApiModelFromMap(
        String str) =>
    MonthWiseEventCalendarApiModel.fromMap(json.decode(str));

String monthWiseEventCalendarApiModelToMap(
        MonthWiseEventCalendarApiModel data) =>
...
class MonthWiseEventCalendarApiModel {
  ...
  factory MonthWiseEventCalendarApiModel.fromMap(Map<String, dynamic> json) =>
      MonthWiseEventCalendarApiModel(
        monthWiseCalendarData: json["month_wise_calendar_data"] == null
            ? null
            : MonthWiseCalendarData.fromMap(json["month_wise_calendar_data"]),
        mode: json["mode"],
        status: json["status"],
      );
...
class MonthWiseCalendarData {
  ...
  final List<AcademicCalendarHead>? acCalendarHead;
  ...
  MonthWiseCalendarData copyWith({
    ...
    List<AcademicCalendarHead>? acCalendarHead,
  }) =>
      MonthWiseCalendarData(
  ...
  factory MonthWiseCalendarData.fromMap(Map<String, dynamic> json) =>
      MonthWiseCalendarData(
        eventDateList: json["event_date_list"] == null
            ? []
            : List<List<EventDateList>>.from(json["event_date_list"]!.map((x) =>
                List<EventDateList>.from(
                    x.map((x) => EventDateList.fromMap(x))))),
        acCalendarHead: json["ac_calendar_head"] == null
            ? []
            : List<AcademicCalendarHead>.from(json["ac_calendar_head"]!
                .map((x) => AcademicCalendarHead.fromMap(x))),
      );
...
class AcademicCalendarHead {
    ...
    factory AcademicCalendarHead.fromMap(Map<String, dynamic> json) => AcademicCalendarHead(
        id: json["id"],
        name: json["name"],
...
class EventDateList {
  ...
  final int? siteId;
  final AcademicCalendarHead? academicCalendarHead;
  ...
  EventDateList copyWith({
    ...
    int? academicGroupId,
    int? siteId,
    AcademicCalendarHead? academicCalendarHead,
  }) =>
      EventDateList(
  ...
  factory EventDateList.fromMap(Map<String, dynamic> json) => EventDateList(
        ...
        academicCalendarHead: json["academic_calendar_head"] == null
            ? null
            : AcademicCalendarHead.fromMap(json["academic_calendar_head"]),
      );
