...
class QuizMainModel {
    ...
    factory QuizMainModel.fromJson(String str) => QuizMainModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory QuizMainModel.fromMap(Map<String, dynamic> json) => QuizMainModel(
