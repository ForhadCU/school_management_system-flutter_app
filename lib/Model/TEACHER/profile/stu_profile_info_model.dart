...
class TeachProfileInfoModel {
  ...
  TeachProfileInfoModel copyWith({
    int? id,
    String? username,
    String? firstName,
    dynamic lastName,
  ...
  factory TeachProfileInfoModel.fromJson(String str) =>
      TeachProfileInfoModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TeachProfileInfoModel.fromMap(Map<String, dynamic> json) =>
      TeachProfileInfoModel(
        id: json["id"],
