...
class ExamAttendanceListModel {
    ...
    ExamAttendanceListModel copyWith({
        ...
        ExamAttendanceListModel(
            studentListForAttendance: studentListForAttendance ?? this.studentListForAttendance,
            examTypeList: examTypeList ?? this.examTypeList,
            mode: mode ?? this.mode,
            status: status ?? this.status,
        );

    factory ExamAttendanceListModel.fromJson(String str) => ExamAttendanceListModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory ExamAttendanceListModel.fromMap(Map<String, dynamic> json) => ExamAttendanceListModel(
        studentListForAttendance: json["StudentListForAttendance"] == null ? [] : List<StudentListForAttendance>.from(json["StudentListForAttendance"]!.map((x) => StudentListForAttendance.fromMap(x))),
    ...
    Map<String, dynamic> toMap() => {
        "StudentListForAttendance": studentListForAttendance == null ? [] : List<dynamic>.from(studentListForAttendance!.map((x) => x.toMap())),
...
class StudentListForAttendance {
    ...
    StudentListForAttendance copyWith({
        ...
        StudentListForAttendance(
            ...
            siteExamDeclareStudentSubject: siteExamDeclareStudentSubject ?? this.siteExamDeclareStudentSubject,
            studentHistory: studentHistory ?? this.studentHistory,
        );

    factory StudentListForAttendance.fromJson(String str) => StudentListForAttendance.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory StudentListForAttendance.fromMap(Map<String, dynamic> json) => StudentListForAttendance(
        id: json["id"],
        ...
        siteExamDeclareStudentSubject: json["site_exam_declare_student_subject"] == null ? [] : List<SiteExamDeclareStudentSubject>.from(json["site_exam_declare_student_subject"]!.map((x) => SiteExamDeclareStudentSubject.fromMap(x))),
    ...
    Map<String, dynamic> toMap() => {
        ...
        "site_exam_declare_student_subject": siteExamDeclareStudentSubject == null ? [] : List<dynamic>.from(siteExamDeclareStudentSubject!.map((x) => x.toMap())),
...
class SiteExamDeclareStudentSubject {
    ...
    SiteExamDeclareStudentSubject copyWith({
        ...
        SiteExamDeclareStudentSubject(
            ...
            studentHistoryId: studentHistoryId ?? this.studentHistoryId,
            siteExamDeclareId: siteExamDeclareId ?? this.siteExamDeclareId,
            siteExamDeclareStudentId: siteExamDeclareStudentId ?? this.siteExamDeclareStudentId,
            ...
            attendanceSubmitByMachine: attendanceSubmitByMachine ?? this.attendanceSubmitByMachine,
            loadingShow: loadingShow ?? this.loadingShow,
            academicExamType: academicExamType ?? this.academicExamType,
        );

    factory SiteExamDeclareStudentSubject.fromJson(String str) => SiteExamDeclareStudentSubject.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory SiteExamDeclareStudentSubject.fromMap(Map<String, dynamic> json) => SiteExamDeclareStudentSubject(
        id: json["id"],
...
class Student {
    ...
    factory Student.fromMap(Map<String, dynamic> json) => Student(
        ...
        compulsorySubjectIds: json["compulsory_subject_ids"] == null ? [] : List<SubjectId>.from(json["compulsory_subject_ids"]!.map((x) => SubjectId.fromMap(x))),
        selectiveCompulsorySubjectIds: json["selective_compulsory_subject_ids"] == null ? [] : List<SubjectId>.from(json["selective_compulsory_subject_ids"]!.map((x) => SubjectId.fromMap(x))),
        optionalSubjectIds: json["optional_subject_ids"] == null ? [] : List<SubjectId>.from(json["optional_subject_ids"]!.map((x) => SubjectId.fromMap(x))),
...
class SubjectId {
    ...
    factory SubjectId.fromMap(Map<String, dynamic> json) => SubjectId(
        ...
        translations: json["translations"] == null ? [] : List<CompulsorySubjectIdTranslation>.from(json["translations"]!.map((x) => CompulsorySubjectIdTranslation.fromMap(x))),
    );
...
class CompulsorySubjectIdTranslation {
    ...
    factory CompulsorySubjectIdTranslation.fromJson(String str) => CompulsorySubjectIdTranslation.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory CompulsorySubjectIdTranslation.fromMap(Map<String, dynamic> json) => CompulsorySubjectIdTranslation(
        id: json["id"],
