...
class TeachAttendance extends GetView<TeachAttendanceController> {
  const TeachAttendance({super.key});

  @override
  Widget build(BuildContext context) {
    // final controller = TeachAttendanceController.to;
    return BaseWidget(
  ...
  vDailyAttendanceTable() {
    return Obx(() => controller.isLoading.value
        ...
        : controller.teachAttendanceList.isEmpty
            ? Container(
                alignment: Alignment.center,
                child: Text(
                  "No Data!",
                      ...
                      child: SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            children: <TableRow>[
                              ...
                              for (var item
                                  in controller.teachAttendanceList) // test
              ...
              children: [
                Expanded(
                  child: CommonContainers.vTabItemContainer(
                      ...
                      isActive: controller.isDailyAttendaceTabActive.value,
                      onTap: () {
              ...
              child: GestureDetector(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    (AppSpacing.sm).width,
                    Obx(() => Text(
                          controller.mGetFormatDate(controller.endDate),
                          style: kBody.copyWith(
