                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        item.outTime != null
                                            ? "${Utils().getTimeFromTimeStamp("${item.date} ${item.inTime}", kAppTimeFormat12)} \n-\n${Utils().getTimeFromTimeStamp("${item.date} ${item.outTime}", kAppTimeFormat12)}"
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: item.status!.contains("Intime")
